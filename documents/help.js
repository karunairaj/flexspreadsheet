...
function respondToSearchButton() 
{
	...
	if( isDblByte ) {		myStr = checkTheInputString2();	}	else if (isT4) {		myStr = checkTheInputString3();	}	else {		myStr = checkTheInputString();		}
	srch_message = myStr;	srch_1_shot = srch_message.length ? 0 : 1;
	doIEsearch();
}
//--------------------------------------------------
